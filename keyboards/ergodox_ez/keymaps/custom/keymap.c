 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+---------|
 * | LSPO   |Alt/Z |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |Alt// | RSPC    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+---------'
 *   |      |   [  |   -  |   App|CSTAB |                                       |  CTAB|   App|   =  |   ]  |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                         ,------------.       ,------------.
...
[BASE] = LAYOUT_ergodox(
  ...
  KC_LSPO,        ALT_T(KC_Z),  KC_X,    KC_C,      KC_V,      KC_B,    KC_TRNS,
  KC_TRNS,        KC_MINS,      KC_EQL,  C(KC_TAB), KC_TRNS,
                                                                 KC_TRNS, KC_TRNS,
                                                                          KC_TRNS,
                                                  GUI_T(KC_SPC), KC_TRNS, KC_TRNS,
  // right hand
  KC_TRNS,          KC_6,    KC_7,           KC_8,     KC_9,    KC_0,            KC_BSPC,
  KC_TRNS,          KC_Y,    KC_U,           KC_I,     KC_O,    KC_P,            KC_BSLS,
                    KC_H,    KC_J,           KC_K,     KC_L,    LT(FN, KC_SCLN), CTL_T(KC_QUOT),
  KC_TRNS,          KC_N,    KC_M,           KC_COMM,  KC_DOT,  ALT_T(KC_SLSH),  KC_RSPC,
                    KC_TRNS, KC_APP,         KC_LBRC,  KC_RBRC, KC_TRNS,
  KC_TRNS, KC_TRNS,
  KC_TRNS,
  KC_TRNS, KC_TRNS, GUI_T(KC_ENT)
),
